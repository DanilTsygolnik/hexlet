...
> Введение хорошей абстракции может существенно снизить сложность программы в одном месте без сильного усложнения программы в целом. [^oop-intro]
...
- [ ] свойства, setters, getters, deleters (перенести с рукописей)
- [ ] наследование (перенести с рукописей)
- [ ] исключения -- в ветку по тестированию (перенести с рукописей)
